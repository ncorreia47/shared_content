...
Claro! Aqui está uma versão aprimorada da documentação que explica a criação e uso dos templates de DAGs, bem como o padrão de nomenclatura dos arquivos:
...
common: # Parâmetros comuns entre os processos.
  ...
  secret_db_url_conn: sm_url_conn_oracle_tasy_cloud
  secret_db_user: sm_user_oracle_tasy_cloud
  secret_db_pwd: sm_password_oracle_tasy_cloud
...
### Template ``external_data_pipeline``
### TO-DO